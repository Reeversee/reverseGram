...
public class HeaderSettingsCell extends FrameLayout {
    ...
    public HeaderSettingsCell(Context context) {
        ...
        titleTextView.setText(String.format("%s %s", LocaleController.getString(R.string.reverseAppName), BuildVars.BUILD_VERSION_STRING));
        ...
        subtitleTextView.setText(LocaleController.getString("AboutReverseDescription", R.string.AboutReverseDescription));
