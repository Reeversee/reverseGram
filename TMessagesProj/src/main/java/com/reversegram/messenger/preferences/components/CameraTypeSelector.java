...
public class CameraTypeSelector extends LinearLayout {
    ...
    int currentIcon = ReverseConfig.cameraType;
    ...
    public CameraTypeSelector(Context context) {
        ...
        int selectedButton = ReverseConfig.cameraType;
        ...
        if (animate) {
            ...
            animator.addListener(new AnimatorListenerAdapter() {
                ...
                public void onAnimationEnd(Animator animation) {
                    ...
                    currentIcon = ReverseConfig.cameraType;
    ...
    @Override
    protected void onDraw(Canvas canvas) {
        if (!ReverseConfig.disableDividers && numberPicker.getValue() == 1)
