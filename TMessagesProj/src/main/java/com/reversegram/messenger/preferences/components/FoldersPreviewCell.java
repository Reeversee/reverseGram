...
public class FoldersPreviewCell extends FrameLayout {
    ...
    public void updateTabStyle(boolean animate) {
        if (Objects.equals(currentStyle, ReverseConfig.tabStyle) && animate)
            return;

        oldStyle = currentStyle;
        currentStyle = ReverseConfig.tabStyle;
    ...
    public void updateTabTitle(boolean animate) {
        float to = ReverseConfig.tabIcons != 2 ? 1 : 0;
    ...
    public void updateTabIcons(boolean animate) {
        float to = ReverseConfig.tabIcons != 1 ? 1 : 0;
    ...
    public void updateTabCounter(boolean animate) {
        float to = ReverseConfig.tabCounter ? 1 : 0;
    ...
    private String getAllChatsTabName() {
        return ReverseConfig.hideAllChats ? filters[6][0] : filters[0][0];
    }

    private String getAllChatsTabIcon() {
        return ReverseConfig.hideAllChats ? filters[6][1] : filters[0][1];
    }
