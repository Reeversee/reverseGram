    ...
    public UpdaterBottomSheet2(Context context, BaseFragment fragment, boolean available, String... args) {
        ...
        checkUpdates.setOnClickListener(v -> {
            ...
            UpdaterUtils.checkUpdates(fragment, true, () -> {
                headerCell.getTimeView().setText(LocaleController.getString("LastCheck", R.string.LastCheck) + ": " + LocaleController.formatDateTime(ReverseConfig.lastUpdateCheckTime / 1000));
                checkUpdates.setText(LocaleController.getString("CheckForUpdates", R.string.CheckForUpdates));
            ...
            switch (holder.getItemViewType()) {
                case 0: {
                    ...
                    if (position == versionRow) {
                        ...
                        cell.setTextAndCheckAndIcon(LocaleController.getString("CheckOnLaunch", R.string.CheckOnLaunch), ReverseConfig.checkUpdatesOnLaunch, R.drawable.msg_recent, true);
                    } else if (position == clearCacheRow) {
