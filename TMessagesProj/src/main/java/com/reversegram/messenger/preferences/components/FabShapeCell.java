...
public class FabShapeCell extends LinearLayout {
    ...
    private static class FabShape extends FrameLayout {
        ...
        public FabShape(Context context, boolean square) {
            ...
            setSelected(square && ReverseConfig.squareFab || !square && !ReverseConfig.squareFab, false);
        }
        ...
        protected void onDraw(Canvas canvas) {
            ...
            for (int a = 0; a < 2; a++) {
                ...
                canvas.drawRoundRect(cx - rad, cy - rad, cx + rad, cy + rad, ReverseConfig.getAvatarCorners(rad * 2, true), ReverseConfig.getAvatarCorners(rad * 2, true), Theme.dialogs_onlineCirclePaint);
    ...
    public FabShapeCell(Context context) {
        ...
        for (int a = 0; a < 2; a++) {
            ...
            fabShape[a].setOnClickListener(v -> {
                ...
                ReverseConfig.editor.putBoolean("squareFab", ReverseConfig.squareFab = square).apply();
                rebuildFragments();
            });
        }
    }
