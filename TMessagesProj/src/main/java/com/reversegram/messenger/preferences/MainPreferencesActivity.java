...
import com.reversegram.messenger.preferences.components.HeaderSettingsCell;
import com.reversegram.messenger.preferences.updater.UpdaterBottomSheet;
...
public class MainPreferencesActivity extends BasePreferencesActivity {
    ...
    private int aboutReverseDividerRow;

    private int infoHeaderRow;
    private int aboutReverseRow;
    ...
    protected void updateRowsId() {
        ...
        aboutReverseRow = newRow();
        aboutReverseDividerRow = newRow();
    ...
    protected void onItemClick(View view, int position, float x, float y) {
        if (position == aboutReverseRow) {
            if (!BuildVars.PM_BUILD)
                (new UpdaterBottomSheet(getParentActivity(), this, false)).show();
        } else if (position == sourceCodeRow) {
            Browser.openUrl(getParentActivity(), "https://github.com/Reeversee/reverseGram");
    ...
    private class ListAdapter extends BaseListAdapter {
            ...
            switch (holder.getItemViewType()) {
                ...
                case 2:
                    ...
                    if (position == generalRow) {
                        ...
                        textCell.setTextAndValueAndIcon(LocaleController.getString("Channel", R.string.Channel), "@reverseGram", R.drawable.msg_channel, true);
                    } else if (position == groupRow) {
                        textCell.setTextAndValueAndIcon(LocaleController.getString("SearchAllChatsShort", R.string.SearchAllChatsShort), "@reeverseChat", R.drawable.msg_groups, true);
                    } else if (position == crowdinRow) {
        ...
        public int getItemViewType(int position) {
            if (position == categoryDividerRow || position == aboutReverseDividerRow || position == infoDividerRow) {
                return 1;
            } else if (position == infoHeaderRow || position == categoryHeaderRow) {
                return 3;
            } else if (position == aboutReverseRow) {
                return 4;
            }
            return 2;
        }
