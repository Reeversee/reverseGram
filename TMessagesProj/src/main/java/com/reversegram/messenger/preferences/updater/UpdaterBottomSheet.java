...
package com.reversegram.messenger.preferences.updater;
...
import com.reversegram.messenger.utils.UpdaterUtils;
...
public class UpdaterBottomSheet extends BottomSheet {
    ...
    public UpdaterBottomSheet(Context context, BaseFragment fragment, boolean available, String... args) {
        ...
        timeView.setText(available ? args[4] : LocaleController.getString("LastCheck", R.string.LastCheck) + ": " + LocaleController.formatDateTime(ReverseConfig.lastUpdateCheckTime / 1000));
        ...
        if (available) {
            ...
            doneButton.setOnClickListener(v -> {
                UpdaterUtils.downloadApk(fragment.getContext(), args[3], "reverseGram " + args[0]);
                dismiss();
            });
            ...
            scheduleButton.setOnClickListener(v -> {
                ReverseConfig.editor.putLong("updateScheduleTimestamp", ReverseConfig.updateScheduleTimestamp = System.currentTimeMillis()).apply();
                dismiss();
            });
            ...
            checkOnLaunch.setTextAndCheckAndIcon(LocaleController.getString("CheckOnLaunch", R.string.CheckOnLaunch), ReverseConfig.checkUpdatesOnLaunch, R.drawable.msg_recent, true);
            checkOnLaunch.setOnClickListener(v -> {
                ReverseConfig.editor.putBoolean("checkUpdatesOnLaunch", ReverseConfig.checkUpdatesOnLaunch ^= true).apply();
            ...
            checkUpdates.setOnClickListener(v -> {
                ...
                UpdaterUtils.checkUpdates(fragment, true, () -> {
                    timeView.setText(LocaleController.getString("LastCheck", R.string.LastCheck) + ": " + LocaleController.formatDateTime(ReverseConfig.lastUpdateCheckTime / 1000));
                    checkUpdates.setText(LocaleController.getString("CheckForUpdates", R.string.CheckForUpdates));
