...
package com.reversegram.messenger.preferences.components;
...
public class AvatarCornersPreviewCell extends FrameLayout {
    ...
    public AvatarCornersPreviewCell(Context context, INavigationLayout fragment) {
        ...
        seekBar = new AltSeekbar(context, (float p) -> {
            ReverseConfig.editor.putFloat("avatarCorners", ReverseConfig.avatarCorners = p).apply();
            invalidate();
        ...
        seekBar.setProgress((ReverseConfig.avatarCorners - startCornersSize) / (float) (endCornersSize - startCornersSize));
        ...
        preview = new FrameLayout(context) {
            ...
            protected void onDraw(Canvas canvas) {
                ...
                canvas.drawRoundRect(AndroidUtilities.dp(20), h / 2.0f - AndroidUtilities.dp(28), AndroidUtilities.dp(76), h / 2.0f + AndroidUtilities.dp(28), ReverseConfig.getAvatarCorners(56), ReverseConfig.getAvatarCorners(56), Theme.dialogs_onlineCirclePaint);
            }
        };
    ...
    protected void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        if (!ReverseConfig.disableDividers && needDivider)
