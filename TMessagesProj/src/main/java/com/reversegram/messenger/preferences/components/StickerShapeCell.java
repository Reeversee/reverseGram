...
public class StickerShapeCell extends LinearLayout {
    ...
    private static class StickerShape extends FrameLayout {
        ...
        public StickerShape(Context context, boolean rounded, boolean roundedAsMsg) {
            ...
            setSelected(!isRounded && !isRoundedAsMsg && ReverseConfig.stickerShape == 0 || isRounded && ReverseConfig.stickerShape == 1 || isRoundedAsMsg && ReverseConfig.stickerShape == 2, false);
        }
    ...
    public StickerShapeCell(Context context) {
        ...
        for (int a = 0; a < 3; a++) {
            ...
            stickerShape[a].setOnClickListener(v -> {
                ...
                ReverseConfig.editor.putInt("stickerShape", ReverseConfig.stickerShape = (rounded ? 1 : (roundedAsMsg ? 2 : 0))).apply();
