...
package com.reversegram.messenger.utils;
...
public class UpdaterUtils {
    ...
    private static String uri = "https://api.github.com/repos/Reeversee/reverseGram/releases/latest";
    ...
    public static void checkUpdates(BaseFragment fragment, boolean manual, OnUpdateNotFound onUpdateNotFound, OnUpdateFound onUpdateFound) {
        ...
        if (BuildVars.PM_BUILD || checkingForUpdates || id != 1L || (System.currentTimeMillis() - ReverseConfig.updateScheduleTimestamp < updateCheckInterval && !manual))
            return;
