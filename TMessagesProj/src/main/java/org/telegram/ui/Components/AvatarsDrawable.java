...
public class AvatarsDrawable {
    ...
    public AvatarsDrawable(View parent, boolean inCall) {
        ...
        for (int a = 0; a < 3; a++) {
            ...
            currentStates[a].imageReceiver.setRoundRadius(ReverseConfig.getAvatarCorners(24));
            ...
            animatingStates[a].imageReceiver.setRoundRadius(ReverseConfig.getAvatarCorners(24));
    ...
    public void setObject(int index, int account, TLObject object) {
        ...
        animatingStates[index].imageReceiver.setRoundRadius(ReverseConfig.getAvatarCorners(bigAvatars ? 32 : 24));
        int size = getSize();
            ...
            for (int k = 0; k < 2; k++) {
                ...
                if (a != states.length - 1) {
                    if (currentStyle == 1 || currentStyle == 3 || currentStyle == 5) {
                        canvas.drawRoundRect(imageReceiver.getCenterX() + AndroidUtilities.dp(13), imageReceiver.getCenterY() - AndroidUtilities.dp(13), imageReceiver.getCenterX() - AndroidUtilities.dp(13), imageReceiver.getCenterY() + AndroidUtilities.dp(13), ReverseConfig.getAvatarCorners(26), ReverseConfig.getAvatarCorners(26), xRefP);
                        ...
                        canvas.drawRoundRect(imageReceiver.getCenterX() + AndroidUtilities.dp(17), imageReceiver.getCenterY() - AndroidUtilities.dp(17), imageReceiver.getCenterX() - AndroidUtilities.dp(17), imageReceiver.getCenterY() + AndroidUtilities.dp(17), ReverseConfig.getAvatarCorners(34), ReverseConfig.getAvatarCorners(34), xRefP);
                        if (states[a].wavesDrawable == null) {
                            states[a].wavesDrawable = new GroupCallUserCell.AvatarWavesDrawable(AndroidUtilities.dp(17), AndroidUtilities.dp(21));
                        }
                        ...
                        if (useAlphaLayer) {
                            canvas.drawRoundRect(imageReceiver.getCenterX() + rad, imageReceiver.getCenterY() - rad, imageReceiver.getCenterX() - rad, imageReceiver.getCenterY() + rad, ReverseConfig.getAvatarCorners(rad * 2, true), ReverseConfig.getAvatarCorners(rad * 2, true), xRefP);
                        } else {
