...
import com.reversegram.messenger.components.ChatActivityEnterViewStaticIconView;
...
//                tinyWaveDrawable.tick(radius);
    ...
    public ChatActivityEnterView(Activity context, SizeNotifierFrameLayout parent, ChatActivity fragment, final boolean isChat, Theme.ResourcesProvider resourcesProvider) {
        ...
        if (isChat) {
            ...
            if (ReverseConfig.useSolarIcons) notifySilentDrawable.setPaddings(0, -AndroidUtilities.dp(0.5f), 0, -AndroidUtilities.dp(0.5f));
        ...
        if (sendPopupLayout == null) {
            ...
            ActionBarMenuSubItem translateButton = new TranslateBeforeSendWrapper(getContext(), true, !scheduleButtonValue && !sendWithoutSoundButtonValue, resourcesProvider) {
                ...
                protected void onClick() {
                    if (sendPopupWindow != null && sendPopupWindow.isShowing())
                        sendPopupWindow.dismiss();
                    TranslatorUtils.translate(getEditField().getText(), ReverseConfig.getCurrentLangCode(), translated -> {
