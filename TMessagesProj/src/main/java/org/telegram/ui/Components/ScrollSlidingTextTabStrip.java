...
public class ScrollSlidingTextTabStrip extends HorizontalScrollView {
    ...
    protected boolean drawChild(Canvas canvas, View child, long drawingTime) {
        ...
        if (child == tabsContainer) {
            ...
            selectorDrawable.setBounds((int) x - (ReverseConfig.tabStyle == 3 ? AndroidUtilities.dp(10) : ReverseConfig.tabStyle == 4 ? AndroidUtilities.dp(12) : 0), ReverseConfig.tabStyle >= 3 ? height / 2 - AndroidUtilities.dp(ReverseConfig.tabStyle == 3 ? 17 : 18) : height - AndroidUtilities.dp(4), (int) w + (ReverseConfig.tabStyle == 3 ? AndroidUtilities.dp(10) : ReverseConfig.tabStyle == 4 ? AndroidUtilities.dp(12) : 0), ReverseConfig.tabStyle >= 3 ? height / 2 + AndroidUtilities.dp(ReverseConfig.tabStyle == 3 ? 17 : 18) : height);
